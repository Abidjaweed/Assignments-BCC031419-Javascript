...
var stuPercentage = [(score[0]/500*100), (score[1]/500*100), (score[2]/500*100)]

for (var i = 0; i < 3; i++) {
    document.write("<br> Score of " + names[i] + " is " + score[i] + ". Percentage: " +   stuPercentage[i] + "%") 
}
document.write("<br>"); 
document.write("<br>"); 
...
var citiesUpdated = cities.slice(3, 5)
    ...
    document.write("<br><b>Selected Cities List:</b>" + citiesUpdated)
